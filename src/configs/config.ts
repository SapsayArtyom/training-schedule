        ...
        exercises: [
            {
                ...
                weeks: ['3*8', '2*8', '4*8', '3*8', '4*12', '2*8', '3*8', '4*12', '3*8', '2*8', '4*8', '3*8',],
            },
            {
                ...
                weeks: ['3*15', '2*10', '4*8', '3*12', '4*12', '2*12', '3*20', '4*12', '3*15', '2*10', '4*8', '3*12',],
            },
            {
                name: 'Гиперэкстензия',
                id: 2,
                ...
                weeks: ['3*15', '2*15', '4*15', '3*20', '4*20', '2*15', '3*20', '4*20', '3*15', '2*15', '4*15', '3*20',],
            },
            {
                ...
                weeks: ['3*8', '2*8', '4*12', '3*8', '4*12', '2*8', '3*12', '4*12', '3*8', '2*8', '4*12', '3*8',],
            },
            {
                ...
                weeks: ['3*8', '2*8', '4*8', '3*12', '4*8', '2*8', '3*8', '4*8', '3*8', '2*8', '4*8', '3*12',],
            },
            {
                name: 'Отжимания',
                id: 5,
        ...
        exercises: [
            {
                ...
                weeks: ['3*8', '2*12', '4*12', '3*8', '4*8', '2*8', '3*12', '4*8', '3*8', '2*12', '4*12', '3*8',],
            },
            {
                name: 'Отжимания',
                id: 1,
            ...
            },
            {
                ...
                weeks: ['3*8', '2*8', '4*12', '3*15', '4*8', '2*8', '3*12', '4*8', '3*8', '2*8', '4*12', '3*15',],
            },
            {
                ...
                weeks: ['3*12', '2*8', '4*8', '3*15', '4*8', '2*15', '3*8', '4*15', '3*12', '2*8', '4*8', '3*15',],
            },
            {
                ...
                weeks: ['3*8', '2*8', '4*15', '3*8', '4*15', '2*8', '3*8', '4*15', '3*8', '2*8', '4*15', '3*8',],
            },
            {
                name: 'Тяга блока к поясу',
                id: 5,
                link: 'https://disk.yandex.ru/d/FNbXDkVv2SA6zw/%D0%A2%D1%8F%D0%B3%D0%B0%20%D0%BA%20%D0%BF%D0%BE%D1%8F%D1%81%D1%83',
                weeks: ['3*8', '2*8', '3*8', '3*15', '3*8', '2*12', '3*8', '3*8', '3*8', '2*8', '3*8', '3*15',],
            },
            {
                ...
                weeks: ['3*8', '2*8', '4*12', '3*15', '4*8', '2*8', '3*15', '4*8', '3*8', '2*8', '4*12', '3*15',],
            },
            {
                name: 'Пресс',
                id: 7,
        ...
        exercises: [
            {
                ...
                id: 0,
                link: 'https://disk.yandex.ru/d/FNbXDkVv2SA6zw/%D0%9F%D1%80%D0%B8%D1%81%D0%B5%D0%B4',
                weeks: ['3*20', '2*12', '4*15', '3*20', '4*20', '2*8', '3*15', '3*8', '3*20', '2*12', '4*15', '3*20',],
            },
            {
                name: 'Жим 45',
                id: 1,
                link: 'https://disk.yandex.ru/d/FNbXDkVv2SA6zw/%D0%96%D0%B8%D0%BC45/%D0%96%D0%B8%D0%BC45.mp4',
                weeks: ['3*8', '2*8', '4*12', '3*12', '4*8', '2*8', '3*12', '3*12', '3*8', '2*8', '4*12', '3*12',],
            },
            {
                name: 'Мостик с резинкой',
                id: 2,
                link: 'https://disk.yandex.ru/d/FNbXDkVv2SA6zw/%D0%9C%D0%BE%D1%81%D1%82%D0%B8%D0%BA/%D0%9C%D0%BE%D1%81%D1%82%D0%B8%D0%BA.mp4',
                weeks: ['3*15', '2*10', '4*8', '3*15', '4*12', '2*12', '3*20', '3*8', '3*15', '2*10', '4*8', '3*15',],
            },
            {
                ...
                weeks: ['3*12', '2*8', '4*8', '3*12', '4*8', '2*8', '3*15', '3*12', '3*12', '2*8', '4*8', '3*12',],
            },
            {
                ...
                weeks: ['3*15', '2*12', '4*12', '3*12', '4*12', '2*12', '3*20', '3*8', '3*15', '2*12', '4*12', '3*12',],
            },
            {
